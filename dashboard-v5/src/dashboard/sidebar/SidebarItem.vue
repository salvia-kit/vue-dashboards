...
<template>
  <li>
    <router-link :to="to">
      <span
        class="my-2 flex w-full items-center justify-start p-4 hover:text-white"
        :class="
          route.path === to
            ? 'font-medium text-green-400 hover:text-green-400'
            : 'text-white'
        "
      >
        <span><slot /></span>
        <span
          class="mx-4 whitespace-pre text-sm"
          :class="
            sidebarOpen
